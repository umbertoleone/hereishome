...
const tip = d3.tip()
              ...
              .html(function(d) {
                ...
                +"Denied: " + "<span style='color:orangered'>" + formatComma(d.denied)+"</span>"
...
function getCSVData(){
   d3.csv("data/uscis-forms-new.csv", function(d){
    ...
    //array of colors
    var legendColorsArray = ["yellow", "white", "purple", "orange", "blue"]
